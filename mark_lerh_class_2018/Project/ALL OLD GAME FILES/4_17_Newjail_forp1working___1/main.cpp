...
int main(int argc, char** argv) {
    ...
    int money,payment,p1Position = 0,p2Position = 0,p3Position = start,
            ...
            dice,test,p1Money=100,p2Money=-1000,p3Money=5,p1Yoki=0,p2Yoki=0,p3Yoki=0,count=0,turnskip=0,jail,p1TurnSkip=0,
...
/*     
  ...
  */       
        ...
        if(p2Position == 2 && p1Sp2Ownd == true && p2Sp2Ownd==false && p2Money < 1){
            ...
            cout<<setw(120)<<"You had no yoki to give so you must go to jail!\n";
            cout<<setw(120)<< "*****************************************"<<endl;
        }
           }
  ...
  */ 
                    ...
                    if(p2Position == 5 && p2Sp5Ownd == true)
            {
                cout<<setw(120)<< "*****************************************"<<endl;
  ...
  */ 
         ...
         if(p2Position == 7 && p1Sp7Ownd == true && p2Sp7Ownd==false && p2Money < 1){
            cout<<setw(120)<<"@@You landed on player[1]'s property but dont have enough to pay!"<<endl;
            cout<<setw(120)<< "*****************************************"<<endl;
            cout<<setw(120)<<"Because of this player[2]"<<endl;
            cout<<setw(120)<< "*****************************************"<<endl;
        ...
        if(p2Position == 7 && p2Sp7Ownd == false && p2Money >= 1 && p1Sp7Ownd==true)
        {
            cout<<setw(120)<<"YOU LANDED ON A YOKI SOMEONE ELS OWNDS!!"<<endl;
            cout<<setw(120)<< "*****************************************"<<endl;
            cout<<setw(120)<<"You have to pay $1 "<<endl;
      ...
      if(p2Money < 1 && p2Position == 7  && p1Sp7Ownd==false){
          
      cout<<setw(120)<<"Player[2] did not have enough to buy this yo-ka"<<endl;
                      }
                               
                 if(p2Money >= 1 && p2Position == 7 && p1Sp7Ownd == false && p2Sp7Ownd == false){
                     p2Sp7Ownd = true;
                     p2Money = p2Money-1;
